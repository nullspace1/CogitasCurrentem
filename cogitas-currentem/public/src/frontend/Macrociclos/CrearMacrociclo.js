...
const MacroCicloCrear = () => {
    ...
    const [selectedAtletas, setSelectedAtletas] = (0, react_1.useState)([]);
    ...
    (0, react_1.useLayoutEffect)(() => {
        const fetch = async () => {
            ...
            setAtletas(atletas);
            const initSelectedAtletas = (await new persistence_1.DatabaseInterface(persistence_1.ExistingDatabase.atleta).getAll()).filter(a => ids.findLast(i => i = a.id) !== undefined);
            setSelectedAtletas(initSelectedAtletas);
        };
        fetch();
    }, []);
    const handleCheckChange = (atleta, isChecked) => {
        if (isChecked) {
            setSelectedAtletas([...selectedAtletas, atleta]);
        }
        else {
            setSelectedAtletas(selectedAtletas.filter(i => i.id !== atleta.id));
        }
    };
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("h3", null, "Atletas Disponibles"),
        react_1.default.createElement("select", null, atletas.map(item => (react_1.default.createElement("option", { key: item.id },
            react_1.default.createElement("input", { type: "checkbox", onChange: (e) => handleCheckChange(item, e.target.checked) }),
            item.getNombre())))),
        ...
        listPeriodos.map((p) => react_1.default.createElement("ul", null,
            ...
            react_1.default.createElement("li", null,
                ...
                p.getSemanaFin(),
                " "))),
        react_1.default.createElement("h3", null, "Atletas Seleccionados"),
        react_1.default.createElement("select", null, selectedAtletas.map(item => (react_1.default.createElement("option", { key: item.id },
            react_1.default.createElement("input", { type: "checkbox", onChange: (e) => handleCheckChange(item, e.target.checked) }),
            item.getNombre()))))));
};
